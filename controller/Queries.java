...
//-----Transactions-------------------------------------------------------------
     ...
     * @return 
     */
    static String insertShiftTransactionQuery(String initiatorLoginID, String finalizerLoginID, Timestamp[] shiftTimes, String transactionType, String initiatorManager, boolean initManagerSign, String finalizerManager, boolean finalManagerSign )
    {
...
//-----Messages-----------------------------------------------------------------
    ...
    /**
     * deletes a message from the employees list
     * @param sender the person who sent the message
     * @param reciever the person who received the message
...
//-----Manager Functions--------------------------------------------------------
    ...
    /**
     * change whether this manager is supposed to receive approval notification for his/her employees
     * @param manager the id of the manager
     * @param isApproved the value to set the field to
...
//-----Information Retreival----------------------------------------------------
     ...
     * @param LoginID the id of the worker to pull from
     * @return the query to be executed
     */
    ...
    */
    ...
    /**
     * get the access level of a worker
     * @param empName the employee to check
     * @return the query to be executed
     */
